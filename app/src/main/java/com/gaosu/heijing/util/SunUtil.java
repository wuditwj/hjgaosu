...
//        String str1 = SunUtil.getSunrise(new BigDecimal(104.066507),new BigDecimal(30.625124),new Date());
//        String str2 = SunUtil.getSunset(new BigDecimal(104.066507),new BigDecimal(30.625124),new Date());
